...
![责任链设计模式](images/chain_of_responsibility/chain-of-responsibility.png)
...
![责任链解决的问题](images/chain_of_responsibility/problem1-zh-20200530215823012.png)
...
![每增加一个检查步骤，程序都变得更加臃肿、混乱和丑陋](images/chain_of_responsibility/problem2-zh-20200530215825206.png)
...
![处理者依次排列，组成一条链](images/chain_of_responsibility/solution1-zh-20200530215823204.png)
...
![对象树的枝干可以组成一条链](images/chain_of_responsibility/solution2-zh-20200530215823715.png)
...
![与技术支持交谈可能不容易](images/chain_of_responsibility/chain-of-responsibility-comic-1-zh.png)
...
![责任链设计模式的结构](images/chain_of_responsibility/structure-20200530215823038.png)
...
![责任链结构的示例](images/chain_of_responsibility/example-zh-20200530215823073.png)
...
![责任链结构的示例](images/chain_of_responsibility/example2-zh.png)
...
-  你可以控制请求处理的顺序。
-  [单一职责原则](https://refactoringguru.cn/didp/principles/solid-principles/srp)。 你可对发起操作和执行操作的类进行解耦。
-  [开闭原则](https://refactoringguru.cn/didp/principles/solid-principles/ocp)。 你可以在不更改现有代码的情况下在程序中新增处理者。

...
![装饰设计模式](images/decorator/decorator.png)
...
![创建组合类后的程序库结构](images/decorator/problem3-zh.png)
...
![继承与聚合的对比](images/decorator/solution1-zh.png)
...
![装饰模式解决方案](images/decorator/solution2-zh.png)

将各种通知方法放入装饰。

客户端代码必须将基础通知器放入一系列自己所需的装饰中。 因此最后的对象将形成一个栈结构。

![程序可以配置由通知装饰构成的复杂栈](images/decorator/solution3-zh.png)
...
![装饰模式示例](images/decorator/decorator-comic-1.png)
...
![装饰设计模式的结构](images/decorator/structure.png)
...
![装饰模式示例的结构](images/decorator/example-20200529013152972.png)

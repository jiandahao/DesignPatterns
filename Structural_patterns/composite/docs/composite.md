 / [设计模式](https://refactoringguru.cn/design-patterns) / [结构型模式](https://refactoringguru.cn/design-patterns/structural-patterns)
...
![部队结构的例子](images/composite/live-example.png)

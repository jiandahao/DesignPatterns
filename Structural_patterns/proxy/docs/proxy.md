...
![代理设计模式](images/proxy/proxy.png)

##  问题

为什么要控制对于某个对象的访问呢？ 举个例子： 有这样一个消耗大量系统资源的巨型对象， 你只是偶尔需要使用它， 并非总是需要。

![代理模式解决的问题](images/proxy/problem-zh-20200530184047287.png)
...
![代理模式的解决方案](images/proxy/solution-zh-20200530184047744.png)
...
![信用卡是一大捆现金的代理](images/proxy/live-example-zh-20200530184047654.png)
...
![代理设计模式的结构](images/proxy/structure-20200530184049441.png)
...
![代理模式示例的结构](images/proxy/example-zh-20200530184057031.png)

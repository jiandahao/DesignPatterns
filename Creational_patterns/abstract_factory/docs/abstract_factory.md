...
![生成不同风格的系列家具。](images/abstract_factory/problem-zh.png)
...
![抽象工厂设计模式](images/abstract_factory/structure.png)
...
![抽象工厂模式示例的类图](images/abstract_factory/example.png)
...
##  抽象工厂模式适合应用场景
 ...
 在设计良好的程序中， [每个类仅负责一件事](https://refactoringguru.cn/didp/principles/solid-principles/srp)。 如果一个类与多种类型产品交互， 就可以考虑将工厂方法抽取到独立的工厂类或具备完整功能的抽象工厂类中。
...
-  你可以确保同一工厂生成的产品相互匹配。
-  你可以避免客户端和具体产品代码的耦合。
-  [单一职责原则](https://refactoringguru.cn/didp/principles/solid-principles/srp)。 你可以将产品生成代码抽取到同一位置， 使得代码易于维护。
-  [开闭原则](https://refactoringguru.cn/didp/principles/solid-principles/ocp)。 向应用程序中引入新产品变体时， 你无需修改客户端代码。

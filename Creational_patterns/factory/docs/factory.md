...
![工厂方法模式](images/factory/factory-method-zh.png)
...
![在程序中新增一个运输类会遇到问题](images/factory/problem1-zh.png)
...
![创建者类结构](images/factory/solution1.png)
...
![产品对象层次结构](images/factory/solution2-zh.png)
...
![使用工厂方法模式后的代码结构](images/factory/solution3-zh.png)
...
![工厂方法模式结构](images/factory/structure-20200526094836792.png)
...
![工厂方法模式示例结构](images/factory/example-20200526094836810.png)

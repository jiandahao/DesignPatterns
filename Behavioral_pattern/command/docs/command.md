...
![命令设计模式](images/command/command-zh.png)
...
![多个类实现同一功能](images/command/problem3-zh-20200531020119607.png)
...
![通过命令访问业务逻辑层。](images/command/solution2-zh-20200531020116244.png)
...
![GUI 对象将命令委派给命令对象](images/command/solution3-zh-20200531020113238.png)
...
![在餐厅里点餐](images/command/command-comic-1.png)
...
![命令设计模式的结构](images/command/structure-20200531020113826.png)
...
![命令模式示例的结构](images/command/example-20200531020113987.png)
...
-  [单一职责原则](https://refactoringguru.cn/didp/principles/solid-principles/srp)。 你可以解耦触发和执行操作的类。
-  [开闭原则](https://refactoringguru.cn/didp/principles/solid-principles/ocp)。 你可以在不修改已有客户端代码的情况下在程序中创建新的命令。
-  你可以实现撤销和恢复功能。
-  你可以实现操作的延迟执行。
-  你可以将一组简单命令组合成一个复杂命令。

...
![备忘录设计模式](images/memento/memento-zh.png)
...
![在编辑器中撤销操作](images/memento/problem1-zh-20200602114534425.png)
...
![如何复制对象的私有状态？](images/memento/problem2-zh.png)
...
![备忘录示例的结构](images/memento/example-20200602114534699.png)
